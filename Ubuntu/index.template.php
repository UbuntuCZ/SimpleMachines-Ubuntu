...
<html xmlns="http://www.w3.org/1999/xhtml"', $context['right_to_left'] ? ' dir="rtl"' : '', '><head>';
	...
	<link rel="stylesheet" type="text/css" href="'. $settings['theme_url'] .'/zalozky.css" />';
	...
	echo '<meta http-equiv="x-xrds-location" content="http://forum.ubuntu.cz/xrds.xml" />';
...
<script type="text/javascript">
  ...
  (function() {
	...
	// ]]></script>
	<script language="JavaScript" type="text/javascript" src="' . $settings['theme_url'] . '/zalozky.js"></script>';
...
<div id="mainframe"', !empty($settings['forum_width']) ? ' style="width: ' . $settings['forum_width'] . '"' : '', '>
	<div class="tborder">
		<div class="catbg">
			<img class="floatleft" id="smflogo" src="', $settings['images_url'], '/logo.png" alt="Ubuntu.cz fórum" style="margin:10px 2px 2px 2px" />
			<h1 id="forum_name">';

echo '	
				<div id="sfondobarra"><div id="barra">  <script type="text/javascript">pulsanti("forum")</script>				 </div>  </div>
		  ';
...
///////////////////////////////////////
		...
		if (!empty($modSettings['enableOpenID'])) {
			echo '
				<br />
				<script type="text/javascript">
				function toggleOpenIdVersion(){
					var mojeid_radios = document.getElementsByName("mojeid_toggle");
				    var show = "";
				    for (var i=0; i< mojeid_radios.length; i++){
				        if (mojeid_radios[i].checked){      
				            show = mojeid_radios[i].value;
				        }
				    }
				    var m = document.getElementById("login_mojeid");
				    var o = document.getElementById("login_openid");
				    if (show == "mojeid"){
				...
				window.onload = function(){toggleOpenIdVersion();};
			</script>
			';
			
			echo '<div id="login_openid" style="display:none">
			<input type="radio" name="mojeid_toggle" value="mojeid" checked="checked" onClick="toggleOpenIdVersion()">mojeID</input>
			<input type="radio" name="mojeid_toggle" value="openid" onClick="toggleOpenIdVersion()">OpenID</input>
			...
			<input type="radio" name="mojeid_toggle" value="openid" onClick="toggleOpenIdVersion()">OpenID</input>
		    	...
		    	function setMojeIdFlag_header(){
		    		var elem = document.getElementById("mojeidflag_index_header");
					elem.value = "1";
		    	}</script>
				<br />
				<input type="hidden" name="mojeid" id="mojeidflag_index_header" value="0" />
				<input type="submit" name="openid_identifier_submit" value="MOJEID" onclick="setMojeIdFlag_header()"
				class="mojeid_submit" />
			</div>
			';
		}
